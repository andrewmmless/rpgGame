...
public final class BossPattern {
    private BossPattern() {}
    public static boolean regional(String name){return name.contains("Alpha Wolf")||name.contains("Orc Chieftain")||name.contains("Lich Acolyte")||name.contains("Ashwing");}
