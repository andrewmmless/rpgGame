...
public final class Campaign {
    ...
    public static final List<Region> REGIONS = List.of(
        ...
        new Region(Area.DRAGONS_SPIRE,"Beyond the storm","The corruption leads to Ashwing at the summit, where Cindergard’s old pact with the dragons lies broken. Climb the storm-battered stair and confront the dragon.","Ashwing, the Red Wyrm","At the End of the Sky",new String[]{"Wyvern","Frost Elemental","Shadow Knight","Storm Harpy","Ancient Guardian"}));
