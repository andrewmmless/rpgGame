...
public class GameController {
    ...
    public record Creation(String name,String playerClass,Long generation) {public Creation {if(generation==null)generation=0L;}}
    ...
    @PostMapping("/api/character") public Map<String,Object> create(Principal principal,@RequestBody Creation body) {return games.create(principal.getName(),body.name(),body.playerClass(),body.generation());}
    @PostMapping("/api/command") public Map<String,Object> command(Principal principal,@RequestBody Command body) {return games.command(principal.getName(),body.version(),body.action(),body.value(),body.generation());}
